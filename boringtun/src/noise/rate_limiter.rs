use super::handshake::{b2s_hash, b2s_keyed_mac_16, b2s_keyed_mac_16_2, b2s_mac_24, constant_time_eq};
...
impl RateLimiter {
    ...
    pub fn verify_packet<'a, 'b>(
        ...
        | Packet::HandshakeResponse(HandshakeResponse { sender_idx, .. }) = packet
        {
            ...
            constant_time_eq(&computed_mac1[..16], mac1)
            ...
            if self.is_under_load() {
                ...
                if constant_time_eq(&computed_mac2[..16], mac2).is_err() {
